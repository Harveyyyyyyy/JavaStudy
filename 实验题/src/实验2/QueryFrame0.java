...
//	private MessageJDialog jdialog;
	...
	public QueryFrame0() 
	{
		super("×Ö·û´®Unicode±àÂë²éÑ¯Æ÷");
		this.setBounds(300, 240, 500, 400);
		this.setBackground(Color.lightGray);
		this.setDefaultCloseOperation(EXIT_ON_CLOSE);

		this.getContentPane().setLayout(new FlowLayout(FlowLayout.CENTER));
		this.getContentPane().add(new JLabel("×Ö·û´®",JLabel.CENTER));
		this.text_str=new JTextField("²éÑ¯ºº×Ö±àÂë",28);
...
/*	private class MessageDialog extends JDialog
	{
		...
		{
			super(QueryFrame0.this,"ÌáÊ¾",true);
